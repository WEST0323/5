...
scene.onOverlapTile(SpriteKind.Player, sprites.builtin.field0, function (sprite, location) {
    ...
    game.splash("level 9", "press A to continue")
    info.changeScoreBy(1)
})
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.stairLadder, function (sprite, location) {
    ...
    game.splash("level 7", "press A to continue")
    info.changeScoreBy(1)
})
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.doorClosedNorth, function (sprite, location) {
    ...
    game.splash("level 1", "press A to continue")
    info.changeScoreBy(1)
})
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile3`, function (sprite, location) {
    tiles.setCurrentTilemap(tilemap`级别2`)
    tiles.placeOnRandomTile(mySprite, sprites.dungeon.purpleSwitchUp)
    game.splash("level 10", "press A to continue")
    info.changeScoreBy(1)
})
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.greenSwitchDown, function (sprite, location) {
    ...
    game.splash("level 4", "press A to continue")
    info.changeScoreBy(1)
})
scene.onOverlapTile(SpriteKind.Player, assets.tile`myTile5`, function (sprite, location) {
    tiles.setCurrentTilemap(tilemap`level6`)
    tiles.placeOnRandomTile(mySprite, assets.tile`myTile`)
    game.splash("level 5", "press A to continue")
    info.changeScoreBy(1)
})
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.doorLockedEast, function (sprite, location) {
    ...
    game.splash("level 2", "press A to continue")
    info.changeScoreBy(1)
})
...
scene.onOverlapTile(SpriteKind.Player, sprites.dungeon.chestOpen, function (sprite, location) {
    ...
    game.splash("level 3", "press A to continue")
    info.changeScoreBy(1)
})
